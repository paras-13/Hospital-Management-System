...
<body>
    ...
    <div class="slider">
        <div class="list">
            ...
            <div class="item slider-fade">
                <img src="assets/images/slider/h4.jpg" alt="image4">
            </div>
            <div class="item slider-fade">
            ...
            <div class="item slider-fade">
                <img src="assets/images/slider/h8.jpg" alt="image5">
            </div>
            <div class="item slider-fade">
                ...
                <div class="border border-light rounded">
                    ...
                    <div class="pt-2">
                        ...
                        <a href="hms/user-login.php" target="_blank">
                            <button class="btn btn-outline-danger w-100">Click Here</button>
                        </a>
                    </div>
                </div>
                <div>
    ...
    <section style="margin-top:150px;" id="about_us">
        <div class="about-us">
            ...
            <div class="d-flex justify-content-between w-75" style="margin-left:160px;">
                <div class="w-25 p-4 rounded" style="background-color:rgba(6, 88, 54, 0.824); color:white">
                    <h4>Our Vision</h4>
                    ...
                    <address class="md-margin-bottom-40">
                        ...
                        */
                        ?>
                            ...
                            ?> <br>
                            Phone: <?php //echo $row['MobileNumber']; 
                                    ?> <br>
