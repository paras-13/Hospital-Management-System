...
<head>
	...
	<link rel="stylesheet" href="./assets/css/forgot-password.css"> <!-- Updated CSS for user forgot password styling -->
</head>
...
<body class="forgot-password-body">
	<div class="forgot-password-container">
		<div class="forgot-password-logo">
			<a href="../../index.php">
				<h2>Smart Health | Doctor Password Recovery</h2>
			</a>
		</div>
		...
		<div class="forgot-password-form-box">
			<form class="form-forgot-password" method="post">
				<fieldset>
					...
					<div class="form-group">
						<input type="text" class="forgot-password-input" name="contactno" placeholder="Registered Contact Number" required>
					</div>

					<div class="form-group">
						<input type="email" class="forgot-password-input" name="email" placeholder="Registered Email" required>
					</div>

					<div class="form-actions">
						<button type="submit" class="forgot-password-btn" name="submit">
							Reset <i class="fa fa-arrow-circle-right"></i>
						</button>
					</div>
		...
		<div class="forgot-password-copyright">
			<span class="text-bold text-uppercase">Hospital Management System</span>
		</div>
	</div>
